 ...
 */
package cn.net.compose.di

import cn.net.compose.ui.components.WindowTitleBar
import com.meowool.ammo.ModuleRegistry
import com.meowool.sweekt.isMacSystem
import com.meowool.sweekt.isWindowsSystem

fun ModuleRegistry.componentsModule() {
    singleton<WindowTitleBar> {
        when {
            isMacSystem -> WindowTitleBar.MacOS()
            isWindowsSystem -> WindowTitleBar.Windows()
            else -> WindowTitleBar.Default()
        }
    }
}
